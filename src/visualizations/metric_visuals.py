...
def visualize_metrics(graph: AssetRelationshipGraph) -> Tuple[go.Figure, go.Figure, go.Figure]:
    ...
    fig2.update_layout(title="Relationship Types Distribution", xaxis_title="Relationship Type",
                       yaxis_title="Count", xaxis_tickangle=-45)
    ...
    fig3.add_trace(go.Bar(
        x=event_dates, y=event_impacts, name='Impact Score',
        text=event_names, textposition='outside',
