...
from src.models.financial_models import (
    Equity, Bond, Commodity, Currency, RegulatoryEvent, 
    AssetClass, RegulatoryActivity
)
...
class RealDataFetcher:
    ...
    def create_real_database(self) -> AssetRelationshipGraph:
        ...
        try:
            ...
            logger.info(f"Real database created with {len(graph.assets)} assets and {sum(len(rels) for rels in graph.relationships.values())} relationships")
            return graph
