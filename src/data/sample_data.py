...
def create_sample_database() -> AssetRelationshipGraph:
    ...
    try:
        ...
        fed_rate_decision = RegulatoryEvent(
            id="FED_RATE_2024", asset_id="US10Y", event_type=RegulatoryActivity.INTEREST_RATE_CHANGE,
        ...
        commodity_volatility = RegulatoryEvent(
            id="ENERGY_VOLATILITY", asset_id="CL_CRUDE", event_type=RegulatoryActivity.MARKET_DISRUPTION,
